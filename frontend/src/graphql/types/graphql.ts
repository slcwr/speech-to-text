...
export type CompleteAnswerMutation = { __typename?: 'Mutation', completeAnswer: { __typename?: 'CompleteAnswerResponse', isInterviewComplete: boolean, message: string, nextQuestion?: { __typename?: 'InterviewQuestionResponse', id: string, sessionId: string, question: string, orderNumber: number, metadata?: any | null, createdAt: string, updatedAt: string } | null, progress: { __typename?: 'InterviewProgress', completed: number, total: number, remaining: number } } };
